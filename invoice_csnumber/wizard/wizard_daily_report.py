...
class WizardDailyReport(osv.TransientModel):
    ...
    def fetch_record(self):
        self.env.cr.execute('select jour_en.name journal_entry,jour_it.ref,part.name partner_name,acc_jou.name journal,acc_acc.name account_name,jour_en.date,jour_it.credit,jour_it.debit from public.account_move_line jour_it'
                             ...
                             +'and jour_it.journal_id='+"'"+str(self.journal_id_daily.id )+"'"+' order by jour_en.name asc,jour_it.debit desc')
