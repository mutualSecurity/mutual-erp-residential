...
class report_webkit_actions(osv.osv_memory):
    ...
    _columns = {
       ...
       'open_action':fields.boolean('Open added action', help="Check this to views the newly added internal print action after creating it (technical views) "),
    }
    _defaults = {
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        """ Changes the views dynamically
         @param self: The object pointer.
         @param cr: A database cursor
         @param uid: ID of the user currently logged in
         @param context: A standard dictionary 
         @return: New arch of views.
        """
